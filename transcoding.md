...
```
  ...
  - `-ethUrl` is the RPC endpoint used to connect to Arbitrum One network. Here we will use a publicly-available RPC endpoint. See notes below.
...
<img width="1918" height="773" alt="Image" src="https://github.com/user-attachments/assets/d12209b5-54f5-4c50-99d8-5ae980ce31af" />
...
<img width="1918" height="338" alt="Image" src="https://github.com/user-attachments/assets/48a5f2c0-092d-4d6a-b409-620b68791b5e" />

Note: due to rate-limiting on the publicly-available RPC endpoint, the process may need to be restarted in order to poll all required blocks. Once you have deposited as a Gateway, you ought to be able to request a permanent endpoint from [LiveInfraSPE](https://liveinfraspe.com/).
